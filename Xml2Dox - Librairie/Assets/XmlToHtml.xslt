...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:foo="http://foo.com" exclude-result-prefixes="foo">
	...
	<xsl:template name="GetStyle">
		<style>
			...
			p.reference, p.definition { font: 400 14px/22px; }
			...
			.classindex dl.odd { background-color: #F8F9FC; }
			...
			.contents a:visited { color: #4665A2; }
			...
			a.codeRef, a.codeRef:visited, a.lineRef, a.lineRef:visited { color: #4665A2; }
			...
			ul { overflow: visible; }
			#side-nav ul { overflow: visible; /* reset ul rule for scroll bar in GENERATE_TREEVIEW window */ }
			#main-nav ul { overflow: visible; /* reset ul rule for the navigation bar drop down lists */ }
			.fragment {
			  text-align: left;
			  direction: ltr;
			...
			span.lineno a { background-color: #D8D8D8; }
			span.lineno a:hover { background-color: #C8C8C8; }
			.lineno {
			...
			img.formulaDsp { }
			img.formulaInl, img.inline { vertical-align: middle; }
			div.center {
				text-align: center;
				margin-top: 0px;
				margin-bottom: 0px;
			...
			*/
			...
			.memItemRight, .memTemplItemRight { width: 100%; }
			.memTemplParams {
				color: #4665A2;
				white-space: nowrap;
				font-size: 80%;
			...
			.memitem.glow { box-shadow: 0 0 15px cyan; }
			.memname {
				font-weight: 400;
				margin-left: 6px;
			}
			...
			table.directory { font: 400 14px Roboto,sans-serif; }
			/* @end */
			div.dynheader {
				margin-top: 8px;
				-webkit-touch-callout: none;
			...
			.navpath li.navelem a:hover { color:#6884BD; }
			.navpath li.footer
			{
				list-style-type:none;
				float:right;
			...
			#projectlogo img { border: 0px none; margin-left: 15px; margin-right: 15px;}
			#projectalign { vertical-align: middle; padding-left: 0.5em; }
			#projectname { color: white; font: 200%; margin: 0px; padding: 2px 0px; }
			#projectbrief { color: white; font: 90%; margin: 0px; padding: 0px; }
			#projectnumber { color:white; font: 50%; margin: 0px; padding: 0px; }
			#titlearea
			{
			...
			.image, .dotgraph, .mscgraph, .diagraph, .plantumlgraph { text-align: center; }
			.caption { font-weight: bold; }
			...
			div.toc li.level3 { margin-left: 30px; }
			div.toc li.level4 { margin-left: 45px; }
			span.emoji {
			...
			.inherit_header td { padding: 6px 0px 2px 5px; }
			...
			#powerTip div.ttdeci { color: #006318; }
			#powerTip div {
					margin: 0px;
					padding: 0px;
			...
			#powerTip.s:after,  #powerTip.s:before,
			#powerTip.se:after, #powerTip.se:before,
			#powerTip.sw:after, #powerTip.sw:before { bottom: 100%; }
			...
			#powerTip.s:after, #powerTip.s:before { left: 50%; }
			#powerTip.sw:after, #powerTip.sw:before { right: 14px; }
			...
			th.markdownTableHeadLeft, td.markdownTableBodyLeft { text-align: left }
			th.markdownTableHeadRight, td.markdownTableBodyRight { text-align: right }
			th.markdownTableHeadCenter, td.markdownTableBodyCenter { text-align: center }
			.DocNodeRTL {
			  text-align: right;
			  direction: rtl;
			}
